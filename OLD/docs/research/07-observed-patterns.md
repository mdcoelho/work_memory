...
- The founder works across customer, supplier, product, problem, decision, meeting, artifact, reporting, urgent-request, operational, unfinished-thought, and partially completed contexts.
- The founder owns multiple simultaneous contexts.
...
- The founder values context more than timers.
...
- Notion, wikis, CRMs, and project management systems represent categories outside the core product shape.
...
- Supplier questions force movement between supplier, product, business, technical, and decision contexts.
- The same container can show an artifact without explaining the current work context.
- The founder can stay inside one container while switching between unrelated contexts.
- The founder can move across several containers while staying inside one context.
