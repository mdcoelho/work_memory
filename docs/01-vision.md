...
The product is not trying to become a better task manager. It is trying to solve a different problem: helping users remember what happened across a fragmented workday.

When the user returns after an interruption, Work Memory should help them answer:

- What was I doing?
- What changed?
- Why did it matter?
- Where should I resume?
- What should I be able to explain later?

## Desired user outcome

The user should end the day with a useful record of work, not just a list of unfinished obligations.

A good Work Memory helps the user understand progress, reconstruct decisions, prepare updates, and restart work without searching across multiple tools.
